...
function Header () {
  return (
    <header className="bg-[#101822] border-b-[1px] px-0 md:px-20 pt-7 border-gray-800 fixed top-0 w-full z-10">
      <div className="flex items-center justify-between space-x-2 font-semibold">
        ...
        <div className="flex items-center text-[#00bcff] gap-4 pr-4 md:pr-0">
